...
global m_z_t_min = m_z_0
global v_z_t_min = v_z_0
global m_x_t_min = m_x_0 
global v_x_t_min = v_x_0
global mwx_t_min = f(m_z_0)
global vwx_t_min = v_z_0
...
for t = 1:T
    ...
    # Execute algorithm
    for i = 1:n_its
        stepMFZMinMF!(data, marginals_mf)
        stepMFXMF!(data, marginals_mf)
        stepMFZMF!(data, marginals_mf)
...
run(bench_evmp, samples=100, seconds=10000)
